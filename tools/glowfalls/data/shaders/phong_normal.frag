...
void main() {
    ...
    vec3 n = 2.0*vec3(texture(texnormalmap, texcoord)) - vec3(1.0, 1.0, 1.0);
    float ka = 0.1;
    ...
    outcolor = vec4(ka*kd + 1.5*kd*diffuse*lightintensity*(1.0 - smoothstep(0.0, radius, d)),texcolor.a);
}
