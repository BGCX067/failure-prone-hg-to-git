...
INCDIRS		+= src src/math src/renderer src/util src/util/chipmunk src/util/chipmunk/constraints

# Additional locations for library files
LIBDIRS		+= 

# Additional locations for source files
SRCDIRS		= src src/math src/renderer src/util src/util/chipmunk src/util/chipmunk/constraints
