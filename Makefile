...
INCDIRS		+= src src/math src/renderer src/util src/util/chipmunk src/util/chipmunk/constraints src/util/procedural

# Additional locations for library files
LIBDIRS		+= 

# Additional locations for source files
SRCDIRS		= src src/math src/renderer src/util src/util/chipmunk src/util/chipmunk/constraints src/util/procedural
